      ...
      if (process.client && this.options.watchLoggedIn) {
        this.$storage.watchState('loggedIn', loggedIn => {
          if (!routeOption(this.ctx.route, 'auth', false)) {
            if (loggedIn && !isSameURL(this.ctx.from.fullPath, this.ctx.route.fullPath)) {
              const from = this.options.fullPathRedirect ? this.ctx.from.fullPath : this.ctx.from.path
